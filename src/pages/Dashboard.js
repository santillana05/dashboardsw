...
const data = [
    {
      id:1,
      video:
        "Como Hacer un Split en React JS || React Split Pane",
      fecha: "6 de sep. 2020",
      visualizaciones: 32,
        ...
        <div className={classes.root}>
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={4} md={4} lg={4} xl={4}>
                   <CardsHeader icono={<YouTubeIcon className={classes.iconos}/>} titulo="Luis" texto="santillana05" color="rgba(248,80,50,1)" font="white"/>
                </Grid>
                <Grid item xs={12} sm={4} md={4} lg={4} xl={4}>
